					    ...
					    int show_errors)
{
	...
	case OUI_MICROSOFT:
		...
		case WMM_OUI_TYPE:
			...
			case WMM_OUI_SUBTYPE_TSPEC_ELEMENT:
				...
				break;
			default:
				os_null_printf(MSG_EXCESSIVE, "unknown WMM "
					   "information element ignored "
					   "(subtype=%d len=%lu)",
		...
		case 4:
			...
			break;
		default:
			os_null_printf(MSG_EXCESSIVE, "Unknown Microsoft "
				   "information element ignored "
				   "(type=%d len=%lu)",
	...
	case OUI_WFA:
		...
		case HS20_OSEN_OUI_TYPE:
			...
			break;
		default:
			os_null_printf(MSG_MSGDUMP, "Unknown WFA "
				   "information element ignored "
				   "(type=%d len=%lu)",
				   pos[3], (unsigned long) elen);
			return -1;
	...
	case OUI_BROADCOM:
		...
		case VENDOR_VHT_TYPE:
			...
			break;
		default:
			os_null_printf(MSG_EXCESSIVE, "Unknown Broadcom "
				   "information element ignored "
				   "(type=%d len=%lu)",
				   pos[3], (unsigned long) elen);
			return -1;
	...
	default:
		os_null_printf(MSG_EXCESSIVE, "unknown vendor specific "
